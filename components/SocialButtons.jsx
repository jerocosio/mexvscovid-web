function SocialButtons({ project }) {
    ...
    return (
        <div className="flex">
            ...
            {ig_url ? (
                <a href={ig_url}>
                    <button aria-label="Link de Instagram" className="transition duration-300 ease-in-out  mx-1 bg-covid-500  text-white font-bold py-2 px-3 border-b-4 border-covid-600 hover:bg-purple-500 rounded hover:border-purple-700">
            ...
            {project.pagina_web ? (
                <a href={project.pagina_web}>
                    <button aria-label="Página web" className="transition duration-300 ease-in-out  mx-1 bg-covid-500  text-white font-bold py-2 px-3 border-b-4 border-covid-600 hover:bg-covid-600 rounded hover:border-covid-600">
