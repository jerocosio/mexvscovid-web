...
const HeroButton = ({ id, name, icon, number }) => (
    <Link href={`directorio?cat=${name}`}>
        <a className="transition duration-500 ease-in-out transform w-1/3 hover:bg-green-700 hover:shadow-md justify-center w-auto shadow  py-4 px-4 rounded m-6 bg-covid-200 hover:scale-105">
