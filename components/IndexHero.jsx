        ...
        <div className="lg:py-12 container mx-auto flex flex-col lg:flex-row">
            <div className="flex flex-col justify-center lg:w-1/2">
                <div className="flex flex-col ">
                    <h2 className="text-xl text-center lg:text-4xl text-gray-900 leading-normal p-2 lg:py-6">Apoya negocios afectados por la epidemia del COVID-19 en México.</h2>
